...
International trade · Environmental economics · Urban and regional economics · Applied microeconomics

## Working Papers

See the [Research](/publications/) page for full list and abstracts.

* **Trade War Shocks and Urban Structural Transformation in China.** Manuscript under review at *China Economic Review*.
* **Extreme Weather and Housing Premiums: Evidence from Shanghai.** With Xuezheng Qin and Ke Xu (Peking University). Working paper.
...
* **Programming and Statistical Software:** Stata (panel data, DID), R (tidyverse, fixest, ggplot2), Python (pandas, econometrics)
* **Languages:** Mandarin Chinese (native), English (professional)

## Awards

* American Mathematics Competitions 12A — Top 5%
* American Invitational Mathematics Examination — Qualifier (11/15)
